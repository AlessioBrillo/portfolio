...
FONTS = [
    {
        'family': 'Archivo',
        'source_file': 'Archivo[wdth,wght].ttf',
    ...
    },
    {
        ...
        'source_file': 'ArchivoBlack-Regular.ttf',
        'output_name': 'ArchivoBlack.woff2',
        'license_url': 'https://raw.githubusercontent.com/google/fonts/main/ofl/archivoblack/OFL.txt',
        'license_name': 'ArchivoBlack.OFL.txt',
        'font_face': {
            'family': 'Archivo Black',
            'weight': '900',
            'stretch': '100%',
    ...
    },
    {
        ...
        'source_file': 'JetBrainsMono[wght].ttf',
