...
| Tonal scene     | `ascent/TonalScene.tsx` | Fixed backdrop that crossfades `paper -> night` on scroll (the signature). Wraps `surface="scene"` bands. Framer Motion now; GSAP multi-band engine is Phase 3 (ADR-0003, ADR-0010). |
